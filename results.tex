...
\section{Results} \label{sec:results}
    \begin{table*}
        ...
        \caption{
            % \tiny
            A comparison of \gls{MAE} and \gls{RAE} calculated for the uncensored predictions and true data plus the concordance index and the Brier score. Here U Likelihood refers to Uniform Likelihood loss and CF refers to when the clinical features were included in the model.
        }
